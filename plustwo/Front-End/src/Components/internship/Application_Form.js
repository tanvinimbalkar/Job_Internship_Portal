...
import Appliedto_InternshipDetails from './Appliedto_InternshipDetails'
...
export default function Application_Form({data,appliedIid,isOpenForm}) {
    ...
    async function fetchProfiledata(){
        ...
        await axios
            .post(baseUrl + `/applicant_update`,getDatafor)
            .then(response => {
                console.log(response.data.message)
                if(response.data.message!=='data not found')
                {
                    setName(response.data.message.name)
                    setEmailid(response.data.message.email_id)
                    setPhoneno(response.data.message.phone)
                    setGender(response.data.message.gender)
                    setCity(response.data.message.city)
                    setAddress(response.data.message.address)
                    setSocialMediaLink(response.data.message.linkdin_link)
                }
    ...
    const FilterDataWithIid = () => {
        return data.filter((x)=> x.iid.toString() === appliedIid.toString())
    }
    
    const handleSubmit = (e) =>
    {
        console.log(appliedIid)
    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <Appliedto_InternshipDetails iidDetails={FilterDataWithIid()}/>
                <div className="row">
